...
#define Z_STEPPER_AUTO_ALIGN
  ...
  #define Z_STEPPER_ALIGN_XY { {( MESH_MIN_X + 18 ), 110} , {( MESH_MAX_X - 18 ), 110} }
...
#define FWRETRACT
  ...
  #define FWRETRACT_AUTORETRACT           // Override slicer retractions
    ...
    #define MAX_AUTORETRACT 2.0          // (mm) Don't convert E moves over this length
  #endif
  #define RETRACT_LENGTH 1                // (mm) Default retract length (positive value)
  #define RETRACT_LENGTH_SWAP 9          // (mm) Default swap retract length (positive value)
 ...
 */
  ...
  #if AXIS_IS_TMC(Z2)
    #define Z2_CURRENT    X_CURRENT
    #define Z2_MICROSTEPS  X_MICROSTEPS
